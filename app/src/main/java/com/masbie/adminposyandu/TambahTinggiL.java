...
public class TambahTinggiL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_tinggi_l);
        setTitle("Tambah Batas Tinggi Laki-laki");
    ...
    class AttemptSubmit extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(TambahTinggiL.this);
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost(
                        "http://posyanduanak.com/kenanga/insert_tinggi_l.php");
...
//            Toast.makeText(getApplicationContext(), result, Toast.LENGTH_LONG).show();
            pDialog.dismiss();
            if (result != null) {
                Toast.makeText(TambahTinggiL.this, result, Toast.LENGTH_LONG).show();
            }
            input_bulan.setText("");
            input_b1.setText("");
            input_b2.setText("");
