...
import com.masbie.adminposyandu.EditGrafikBeratL;
import com.masbie.adminposyandu.EditGrafikBeratP;
import com.masbie.adminposyandu.R;

public class AdapterBeratP extends BaseAdapter {
    private Context mContext;
    private String[][] data;
    // Constructor
    public AdapterBeratP(Context c, String[][] data) {
        mContext = c;
        this.data = data;
        ...
        if (convertView == null) {
            ...
            lin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, EditGrafikBeratP.class);
