...
public class TambahBeratP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_berat_p);
        setTitle("Tambah Batas Berat Perempuan");
    ...
    class AttemptSubmit extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(TambahBeratP.this);
...
//            Toast.makeText(getApplicationContext(), result, Toast.LENGTH_LONG).show();
            pDialog.dismiss();
            if (result != null) {
                Toast.makeText(TambahBeratP.this, result, Toast.LENGTH_LONG).show();
            }
            input_b1.setText("");
            input_b2.setText("");
            input_b3.setText("");
