...
import com.masbie.adminposyandu.TambahBeratL;
import com.masbie.adminposyandu.adapter.AdapterAnak;
...
public class PengaturanGrafikBeratL extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pengaturan_grafik_berat_l);
        setTitle("Pengaturan Grafik Berat (Laki-Laki)");
        final SharedPreferences pref = getApplicationContext().getSharedPreferences("loginadmin", 0);
        if(pref.getBoolean("akses", true)){
            Intent intent = new Intent(PengaturanGrafikBeratL.this, LoginActivity.class);
...
//            this.startActivity(intent);
            ...
            progressDialog = new ProgressDialog(PengaturanGrafikBeratL.this);
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(PengaturanGrafikBeratL.this, TambahBeratL.class);
    ...
    protected void parseJSON(View view, String json) {
        ...
        try {
            ...
            gridView.setAdapter(new AdapterBeratL(this, data));
