...
public class PengaturanGrafikTinggiL extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pengaturan_grafik_tinggi_l);
        setTitle("Pengaturan Grafik Tinggi (Laki-Laki)");
        final SharedPreferences pref = getApplicationContext().getSharedPreferences("loginadmin", 0);
        if(pref.getBoolean("akses", true)){
            Intent intent = new Intent(PengaturanGrafikTinggiL.this, LoginActivity.class);
...
//            this.startActivity(intent);
            ...
            progressDialog = new ProgressDialog(PengaturanGrafikTinggiL.this);
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(PengaturanGrafikTinggiL.this, TambahTinggiL.class);
                    startActivity(intent);
                }
            });
        }
    }
    public static final String url = "http://posyanduanak.com/kenanga/view.php?grafik=3";
    ...
    protected void parseJSON(View view, String json) {
        ...
        try {
            ...
            gridView.setAdapter(new AdapterTinggiL(this, data));
