...
public class PengaturanGrafikTinggiP extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pengaturan_grafik_tinggi_p);
        setTitle("Pengaturan Grafik Tinggi (Perempuan)");
        final SharedPreferences pref = getApplicationContext().getSharedPreferences("loginadmin", 0);
        if(pref.getBoolean("akses", true)){
            Intent intent = new Intent(PengaturanGrafikTinggiP.this, LoginActivity.class);
...
//            this.startActivity(intent);
            ...
            progressDialog = new ProgressDialog(PengaturanGrafikTinggiP.this);
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(PengaturanGrafikTinggiP.this, TambahTinggiP.class);
    ...
    protected void parseJSON(View view, String json) {
        ...
        try {
            ...
            gridView.setAdapter(new AdapterTinggiP(this, data));
